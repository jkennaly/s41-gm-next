            ...
            <>
              <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex h-16 items-center justify-between">
                            ...
                            {userNavigation.map((item) => (
                              <Menu.Item key={item.name}>
                                {({ active }) => (
                                  <a
                                    href={item.href}
                                    onClick={item.auth ? () => auth[item.auth]() : null}
                                    className={classNames(
                                      active ? 'bg-gray-100' : '',
                  ...
                  {!authId && <div className="md:block"><Disclosure.Button
                      as="a"
                      onClick={() => auth.login()}
                      className="cursor-pointer inline-flex items-center justify-center rounded-md bg-gray-800 p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                      Log In

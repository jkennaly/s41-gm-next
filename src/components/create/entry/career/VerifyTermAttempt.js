...
const VerifyTermAttempt = ({ setModalContent, term, gameState, userId, room, gameId, character }) => {
    ...
    //console.log('VerifyTermAttempt currentRolls', JSON.parse(JSON.stringify(currentRolls)))
...
export default VerifyTermAttempt;

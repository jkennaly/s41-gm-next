...
const Prison = ({ draftType, gameId, character, handleModalClose, setModalContent, room, termNumber, setTerm}) => {
  ...
  return (
    <div className={`flex flex-col`}>
        <h4 
          className="flex items-center justify-around text-lg leading-6 font-medium text-gray-900"
        >{`Welcome to the Big House`}</h4>
